...
func (i *ImageStandalonePartitionsAction) generateFSTab(context *debos.Context) error {
...
func (i *ImageStandalonePartitionsAction) generateKernelRoot(context *debos.Context) error {
	for _, m := range i.Mountpoints {
		if m.Mountpoint == "/" {
			if m.part.FSUUID == "" {
...
func (i ImageStandalonePartitionsAction) PreMachine(context *debos.Context, m *fakemachine.Machine,
	args *[]string) error {
	return nil
}

func (i ImageStandalonePartitionsAction) formatPartition(p *StandalonePartition, context debos.Context) error {
...
func (i *ImageStandalonePartitionsAction) PreNoMachine(context *debos.Context) error {
	return nil
}

func (i ImageStandalonePartitionsAction) Run(context *debos.Context) error {
...
func (i ImageStandalonePartitionsAction) Cleanup(context *debos.Context) error {
...
func (i ImageStandalonePartitionsAction) PostMachineCleanup(context *debos.Context) error {
...
func (i *ImageStandalonePartitionsAction) Verify(context *debos.Context) error {
